...
# Focused stability regression suite for the DrugClaw research runtime.
...
cargo test --quiet -p drugclaw-tools test_router_falls_back_to_host_when_runtime_missing_and_not_required
cargo test --quiet -p drugclaw-tools test_router_fails_closed_when_runtime_required_and_missing
