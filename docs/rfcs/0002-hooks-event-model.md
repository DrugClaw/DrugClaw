...
DrugClaw has risk-gating in tool runtime but lacks a general lifecycle hook system for policy injection, auditing, and extension.
...
- `drugclaw hooks list`
- `drugclaw hooks info <name>`
- `drugclaw hooks enable <name>`
- `drugclaw hooks disable <name>`
