...
use drugclaw_channels::channel_adapter::ChannelAdapter;
#[cfg(test)]
use drugclaw_core::llm_types::{ContentBlock, ImageSource, MessageContent};
...
pub async fn transcribe_audio(
    ...
    if provider == "local" {
        ...
        drugclaw_app::transcribe::transcribe_audio(openai_key, audio_bytes).await
    }
}
...
mod tests {
    ...
    use drugclaw_storage::db::StoredMessage;
    ...
    fn test_render_markdown_v2_safe_heading_and_bold() {
        ...
        assert!(rendered.contains("I am *DrugClawBot*"));
    }
