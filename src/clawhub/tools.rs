...
impl Tool for ClawHubInstallTool {
    ...
    fn definition(&self) -> ToolDefinition {
        ToolDefinition {
            ...
            description: "Install a skill from ClawHub into ~/.drugclaw/skills/ (or configured skills dir). Use this instead of running clawdhub CLI commands - this is the built-in way to install ClawHub skills."
                .to_string(),
            input_schema: schema_object(
                serde_json::json!({
                    "slug": {
                ...
                .await
            {
                Ok(result) => {
                    ...
                    if result.requires_restart {
                        msg.push_str("\nRestart DrugClaw or run /reload-skills to activate.");
                    }
