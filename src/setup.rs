...
use drugclaw_tools::sandbox::{selected_runtime_cli, DEFAULT_SANDBOX_IMAGE};
...
fn default_sandbox_enabled_for_setup() -> bool {
    let Some(cli) = selected_runtime_cli(SandboxBackend::Auto) else {
        return false;
    };
...
impl SetupApp {
    ...
    fn new() -> Self {
        ...
        let sandbox_enabled_default = existing
            .get("SANDBOX_ENABLED")
            .cloned()
            .unwrap_or_else(|| default_sandbox_enabled_for_setup().to_string());
    ...
    fn default_value_for_field(&self, key: &str) -> String {
        ...
        match key {
            ...
            "SANDBOX_ENABLED" => default_sandbox_enabled_for_setup().to_string(),
